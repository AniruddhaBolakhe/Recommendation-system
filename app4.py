...
genai.configure(api_key="AIzaSyCuy_SDBstrdMRxaDVwP_c9ChtU9GN9v88")
...
def create_connection():
    return mysql.connector.connect(
        ...
        user='root',    # e.g., 'root'
        password='2907',# your MySQL password
        database='student_recommendations'
    )
...
with st.form("Student_details_form"):
    ...
    if submitted:
        ...
        Suggest suitable job positions based on the resume content.
